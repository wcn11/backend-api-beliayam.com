...
const ChargeController = class ChargeController {
    ...
    async createNewCharge(req, res) {
        ...
        if (isChargeNameDuplicate) {
            return res.status(HttpStatus.BAD_REQUEST).send(responser.validation(`Sudah Ada Biaya Dengan Nama: ${input.chargeName}`, HttpStatus.BAD_REQUEST))
        }
